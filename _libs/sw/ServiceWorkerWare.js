...
(function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
        ...
        var debug = ___SWW_DEBUG ? console.log.bind(console, '[ServiceWorkerWare]') : function () { };
        ...
        ServiceWorkerWare.prototype.init = function sww_init() {
            ...
            // push notifications
            //addEventListener('push', this); //[MR THINH: DISABLE PUSH]????????????????????????????????????
        ...
        ServiceWorkerWare.prototype.handleEvent = function sww_handleEvent(evt) {
            ...
            switch (evt.type) {
                case 'install':
                    this.onInstall(evt); if (typeof ___sw_on_install == 'function') ___sw_on_install(evt);
                    break;
                case 'fetch':
                    this.onFetch(evt);

                    var url_ = new URL(evt.request.url);
                    //debug('SW >0 ???????????? url = ', url_.pathname);

                    var url_init_ = location.protocol + '//' + location.host + url_.pathname;
                    if (url_init_ == location.protocol + '//' + location.host + '/init.js') {
                        ...
                        self.clients.matchAll({ includeUncontrolled: true }).then(clients => {
                            ...
                            for (const client of clients) {
                                if (ii == 0) {
                                    ...
                                    scope___ = clientUrl.pathname.substring(1, clientUrl.pathname.length);
                                    console.log('SW > WARE: SCOPE = ' + scope___ + ' | LOAD JS = ' + url_.pathname);
                                    if (typeof ___sw_on_load_init == 'function') setTimeout(___sw_on_load_init, 100);
                                }
                                ii++;
                            }
                        });
                    ...
                    if (url_init_ == location.protocol + '//' + location.host + '/_app/' + scope___ + '/app.js') {
                        console.log('SW > WARE: SCOPE = ' + scope___ + ' | LOAD JS = ' + url_.pathname);
                    }
                    break;
                case 'activate':
                    this.onActivate(evt); if (typeof ___sw_on_activate == 'function') ___sw_on_activate(evt);
                    break;
                //case 'push'://[MR THINH: DISABLE PUSH]????????????????????????????????????
                case 'message':
                case 'beforeevicted':
                case 'evicted':
                    this.forwardEvent(evt); if (evt.type == 'push' && typeof ___sw_on_push == 'function') ___sw_on_push();
                    break;
                default:
